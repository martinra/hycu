...
_code =
  ...
  "  \n"
  "  global int restrict exponent_reduction_table_size,\n"
  "  global int restrict incrementation_table_size,\n"
  "  global int restrict minimal_field_table_size,\n"
  "  \n"
  "  local const int * restrict exponent_reduction_table,\n"
  "  local const int * restrict incrementation_table,\n"
  "  local const int * restrict minimal_field_table,\n"
  "  \n"
